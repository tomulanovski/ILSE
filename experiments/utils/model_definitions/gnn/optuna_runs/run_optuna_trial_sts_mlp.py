...
def objective(trial):
    args = Namespace(
        ...
        # node_to_choose=trial.suggest_categorical("node_to_choose", ["last", "mean"]),
        # graph_type=trial.suggest_categorical("graph_type", ["linear", "virtual_node", "cayley"]),
        ...
        save_dir="./mlp_optuna",  # no actual saving here
